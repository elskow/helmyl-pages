...
const ProjectCard = ({ title, description, href, tech, date, key, ...props }) => {
    return (
        <div
            key={key}
            {...props}
            className="group relative flex flex-col items-start rounded-lg bg-neutral-200 dark:bg-slate-800 border dark:border-gray-700 border-gray-500 max-h-[30rem] w-full mx-auto max-w-[30rem] transition-all duration-300 ease-in-out hover:shadow-lg flex flex-grow flex-col p-6"
        >
